...
export {default as classify, default as toPascalCase} from '@plexis/to-pascal-case';
export {default as pluralize, default as toPlural} from '@plexis/to-plural';
export {default as toPred, default as toPredecessor} from '@plexis/to-pred';
export {default as snakeCase, default as toSnakeCase} from '@plexis/to-snake-case';
...
export {default as humanize, default as toHuman} from '@plexis/to-plural';
export {
